...
uint16_t
    joza_msg_sequence (joza_msg_t *self);
uint16_t
    joza_msg_const_sequence (const joza_msg_t *self);
void
    joza_msg_set_sequence (joza_msg_t *self, uint16_t sequence);
...
zframe_t *
    joza_msg_user_data (joza_msg_t *self);
const zframe_t *
    joza_msg_const_user_data (const joza_msg_t *self);
void
    joza_msg_set_user_data (joza_msg_t *self, zframe_t *frame);
