...
typedef enum _diagnostic_t {
    ...
    d_direction_invalid_negotiation,
            d_invalid_msg_for_state_ready,
            d_invalid_msg_for_state_x_call_request,
            d_invalid_msg_for_state_y_call_request,
            d_invalid_msg_for_state_data_transfer,
            d_invalid_msg_for_state_call_collision,
            d_invalid_msg_for_state_x_clear_request,
            d_invalid_msg_for_state_y_clear_request,
            d_invalid_msg_for_state_x_reset_request,
            d_invalid_msg_for_reset_y_clear_request,
