...
const action_t x_action_table[(int)State::last +1][JOZA_MSG_COUNT] = {
    // state_ready
    {
        a_clear, // data
        a_clear, // rr
...
const action_t y_action_table[(int)State::last + 1][JOZA_MSG_COUNT] = {
    // state_ready
    {
        a_clear, // data
        a_clear, // rr
...
action_t find_action(State s, int msg_id, bool is_y) {
    ...
    action_t a;
    if (is_y)
        a = y_action_table[(int)s][msg_id];
    else
        a = x_action_table[(int)s][msg_id];
    return a;
}
